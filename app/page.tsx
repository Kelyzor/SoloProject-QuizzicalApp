...
export default function StartMenu() {
    return (
        <main className="min-h-screen p-[50px] lg:p-[200px] bg flex flex-col justify-center items-center">
            ...
            <Link href="/quiz"><button className="pt-2 pb-2 pr-7 pl-7 lg:pt-4 lg:pb-4 lg:pr-14 lg:pl-14 cursor-pointer hover:bg-[#414d8a] active:scale-95 active:duration-100 font-inter bg-[#4D5B9E] rounded-2xl text-[#F5F7FB] mt-7 lg:mt-12 font-medium">Start quiz</button></Link>
        </main>
    )
}